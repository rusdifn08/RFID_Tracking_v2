...
const Register = memo(() => {
    ...
    const bagianOptions = useMemo(() => ['SOFTWARE ENGINEER', 'SEWING', 'CUTTING', 'QC', 'PQC', 'ROBOTIC', 'IT', 'HR', 'FINANCE', 'WAREHOUSE', "DRYROOM", "FOLDING", "GUDANG", "IE", 'MANAGER', 'ASS MANAGER', 'ADMIN'], []);
